...
export default function CreateNewPost() {
  ...
  return (
    <div className="mt-10 px-4 pt-4 pb-6 mb-10 rounded-lg border bg-slate-100 dark:bg-slate-900">
      ...
      >
        <input
          className="text-lg outline-slate-300 dark:outline-none dark:focus:bg-slate-700 py-3 px-4 block w-full border-gray-200 rounded-lg text-md disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-800 dark:border-neutral-700 dark:text-slate-200 dark:placeholder-slate-500 dark:focus:ring-neutral-600"
